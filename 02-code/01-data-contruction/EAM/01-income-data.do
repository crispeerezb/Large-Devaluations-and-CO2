...
*===================================================================*
*                          Income data by firm level                *
*===================================================================*

/*
relevant income variable:
VALORVEN
*/
...
foreach year of numlist `start_year'/`end_year' {
	...
	* keep relevant variables 
	...
	valorven /// income by sales. TO DO: add valvfab variable
	
	* rename basic variables
	rename nordemp id_firm	
	
	* save data
	save "${dir_temp}/eam-income/income-data_`year'.dta", replace

}

* Finally we append data
cd "${dir_temp}/eam-income"
use income-data_2000.dta, clear 

foreach year of numlist 2001/2019 {
    append using income-data_`year'.dta
}
...
* We save data
save "${output}/data-stata/eam/01-income-data.dta", replace
