...
df_eam <- read_dta("10-EAM-2005-2019.dta")
...
# we balance panel and drop those firms that i can not follow over time (2005 to 2019)
df_final <- df_final %>%
  group_by(id_firm) %>%
  filter(n() == 15) %>%
  ungroup()
...
write_dta(df_final, "11-EAM-2005-2019-Shift-Share.dta")