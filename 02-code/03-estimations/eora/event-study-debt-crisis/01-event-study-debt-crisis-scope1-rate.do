...
global outcome1="ln_co2_scope1_rate" /*Set outcome scope1_eora or scope12_eora*/
global timevar="year" 
...
*** save graph ***
graph export "${results}\eora\event-study-for-debt-crisis\ES-D-Scope-1 (rate).pdf", as(pdf) replace
