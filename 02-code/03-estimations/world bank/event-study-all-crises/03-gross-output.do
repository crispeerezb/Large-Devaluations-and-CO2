...
gen ln_grossoutput = log(grossoutput)
...
global outcome1="ln_grossoutput" /*Set outcome ln_co2_scope1_rate or ln_co2_scope2_rate*/
global timevar="year" 
global productvar="countrycode"
global controls="lemp lrnna" /*If want to add controls*/
